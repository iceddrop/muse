...
import playTwo from '../assets/Play-2.svg'
...
export default function showOverview(){
    return(
       <section className="chart-category text-white pr-6">
        <div className=' md:flex'>
            <div className='md:flex'>
                <img src={LeadImage} className='chart-img rounded-3xl' alt='chart-image'/>
                <div className='pr-4 mt-4 md:pt-14 md:ml-6 xl:pt-20 lg:pr-10'>
                    ...
                    <div className='flex mt-4 '>
                        ...
                        <div className='flex chart-icon-div ml-3 '>
                            <img src={redHeart} className='' alt='heart-icon'/>
        ...
        <div className='mt-5 chart-songs'>
            <div className='chart-songs-div flex justify-between items-center px-2'>
                <div className='flex'>
                    ...
                    <img src={whiteHeart} className='hidden md:block white-heart ml-3 mt-2' alt='white-heart'/>
                </div>
                <div className='md:flex'>
